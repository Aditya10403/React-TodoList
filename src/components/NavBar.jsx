    ...
    <div>
        <nav className="bg-slate-900">
          <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4">
            ...
            <a href="https://github.com/Aditya10403/React-TodoList" className="text-sm text-blue-600 dark:text-blue-500 hover:underline">Source Code</a>
            <a href="https://adityashukla-portfolio.vercel.app/">
